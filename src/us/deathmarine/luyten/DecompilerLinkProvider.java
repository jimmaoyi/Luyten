...
public class DecompilerLinkProvider implements LinkProvider {
    ...
    public void generateContent() {
        definitionToSelectionMap = new HashMap<String, Selection>();
        referenceToSelectionsMap = new HashMap<String, Set<Selection>>();
                    ...
                    if (text != null && reference != null) {
                        ...
                        if (uniqueStr != null) {
                            ...
                            if (reference instanceof FieldReference) {
                                // fix enum definition links (note: could not
                                // fix enum reference links)
                            ...
                            if (referenceToSelectionsMap.containsKey(uniqueStr)) {
                                ...
                                Set<Selection> selectionsSet = new HashSet<Selection>();
                                selectionsSet.add(new Selection(from, to));
    ...
    public boolean isLinkNavigable(String uniqueStr) {
        ...
        if (isSelectionMapsPopulated) {
            // current type's navigable definitions checked already, now it's
            // erroneous
